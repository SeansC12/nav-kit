...
function SignInForm(param) {
    ...
    var supabase = createClientComponentClient();
    ...
    return /*#__PURE__*/ React.createElement("div", {
        className: "w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 text-primary-blue"
    ...
    }), /*#__PURE__*/ React.createElement(ForgotPassword, null), /*#__PURE__*/ React.createElement(SubmitButton, {
        callback: handleLogin,
        text: "Sign in"
    }), /*#__PURE__*/ React.createElement(SignUpReferral, null), children));
}
